        ...
        public string get_html_ListarMovimientosPagos_str(List<Ent_Movimientos_Pagos> _ListarMovimientosPagos, Ent_Movimientos_Pagos _Ent)
        {
            ...
            try
            {
                ...
                foreach (var item in Lista)
                {
                    ...
                    sb.Append("<td align='right'>" + (item.Importe_Ncredito == null ? " " : string.Format("{0:F2}", item.Importe_Ncredito)) + "</td>\n");
                    sb.Append("<td align='Center'>" + item.Fecha_Ncredito2 + "</td>\n");
                    sb.Append("<td align=''>" + item.Num_Ncredito2 + "</td>\n");
                    sb.Append("<td align='right'>" + (item.Importe_Ncredito2 == null ? " " : string.Format("{0:F2}", item.Importe_Ncredito2)) + "</td>\n");
                    sb.Append("<td align='Center'>" + item.Fecha_Ncredito3 + "</td>\n");
                    sb.Append("<td align=''>" + item.Num_Ncredito3 + "</td>\n");
                    sb.Append("<td align='right'>" + (item.Importe_Ncredito3 == null ? " " :  string.Format("{0:F2}", item.Importe_Ncredito3)) + "</td>\n");
                    sb.Append("<td align='Center'>" + item.Fecha_Ncredito4 + "</td>\n");
                    sb.Append("<td align=''>" + item.Num_Ncredito4 + "</td>\n");
                    sb.Append("<td align='right'>" + (item.Importe_Ncredito4 == null ? " " :  string.Format("{0:F2}", item.Importe_Ncredito4) )+ "</td>\n");
                    sb.Append("<td align='Center'>" + item.Fecha_Ncredito5 + "</td>\n");
                    sb.Append("<td align=''>" + item.Num_Ncredito5 + "</td>\n");
                    sb.Append("<td align='right'>" + (item.Importe_Ncredito5 == null ? " " :  string.Format("{0:F2}", item.Importe_Ncredito5)) + "</td>\n");
                    sb.Append("<td align='Center'>" + item.Fecha_Ncredito6 + "</td>\n");
                    sb.Append("<td align=''>" + item.Num_Ncredito6 + "</td>\n");
                    sb.Append("<td align='right'>" + (item.Importe_Ncredito6 == null ? " " : string.Format("{0:F2}", item.Importe_Ncredito6)) + "</td>\n");
                    sb.Append("<td align='Center'>" + item.Fecha_Ncredito7 + "</td>\n");
                    sb.Append("<td align=''>" + item.Num_Ncredito7 + "</td>\n");
                    sb.Append("<td align='right'>" + (item.Importe_Ncredito7 == null ? " " : string.Format("{0:F2}", item.Importe_Ncredito7)) + "</td>\n");
                    sb.Append("<td align='right'>" + (item.Base_Imponible == null ? " " : string.Format("{0:F2}", item.Base_Imponible)) + "</td>\n");
                    sb.Append("<td align='right'>" + (item.Percepcion == null ? " " : string.Format("{0:F2}", item.Percepcion)) + "</td>\n");
                    sb.Append("<td align='right'>" + (item.Total == null ? " " : string.Format("{0:F2}", item.Total)) + "</td>\n");
                    sb.Append("<td align='Center'>" + item.Fecha_Saldo_Ant + "</td>\n");
                    sb.Append("<td align='right'>" + (item.Importe_Saldo_Ant == null ? " " : string.Format("{0:F2}", item.Importe_Saldo_Ant)) + "</td>\n");
                    sb.Append("<td align='right'>" + (item.Pagar == null ? " " :string.Format("{0:F2}",item.Pagar)) + "</td>\n");
                    sb.Append("<td align='right'>" + (item.Deposito == null ? " " : string.Format("{0:F2}",item.Deposito)) + "</td>\n");
                    sb.Append("<td align='right'>" + (item.Saldo_Favor == null ? " " : string.Format("{0:F2}",item.Saldo_Favor))+ "</td>\n");
                    sb.Append("<td align='right'>" + (item.Ajuste == null ? " " : string.Format("{0:F2}", item.Ajuste)) + "</td>\n");
                    sb.Append("</tr>\n");
                }
                sb.Append("</table></div>");
            }
